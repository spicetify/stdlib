...
export const Menus = Object.fromEntries(
...
export const RemoteConfigProviderComponent = findBy(
   "resolveSuspense",
   "configuration",
)(exportedFunctions) as React.FC<any>;

export const Slider = exportedFunctions.find(
...
export const Nav = exportedMemoFRefs.find(m => (m as any).type.render.toString().includes("navigationalRoot"))!;
export const NavTo = exportedMemoFRefs.find(m => (m as any).type.render.toString().includes("pageId"))!;
...
export const PanelHeader = exportedFunctions.find(
...
export const FilterBox = exportedMemos.find(f => (f as any).type.toString().includes("filterBoxApiRef"));
export const ScrollableContainer = findBy("scrollLeft", "showButtons")(exportedFunctions) as React.FC<any>;
export const ScrollableText = findBy(
   "scrollLeft",
...
export const Tracklist = exportedMemos.find(f => (f as any).type.toString().includes("nrValidItems"));
export const TracklistRow = exportedMemos.find(f => (f as any).type.toString().includes("track-icon"));
